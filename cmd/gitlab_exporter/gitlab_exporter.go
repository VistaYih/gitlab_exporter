...
func (h *handler) innerHandler(filters ...string) (http.Handler, error) {
	...
	r.MustRegister(version.NewCollector("gitlab_exporter"))
	if err := r.Register(nc); err != nil {
		return nil, fmt.Errorf("couldn't register utils collector: %s", err)
	}
...
func main() {
	...
	kingpin.Version(version.Print("gitlab_exporter"))
	kingpin.HelpFlag.Short('h')
	kingpin.Parse()

	log.Infoln("Starting gitlab_exporter", version.Info())
